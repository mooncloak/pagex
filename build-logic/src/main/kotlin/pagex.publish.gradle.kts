...
fun MavenPublication.mavenCentralPom() {
    pom {
        name.set("pagex")
        description.set("Kotlin Multiplatform pagination utilities.")
        url.set("https://github.com/mooncloak/pagex")
        ...
        issueManagement {
            url.set("https://github.com/mooncloak/pagex/issues")
        ...
        developers {
            developer {
                ...
                roles.set(setOf("Primary pagex developer. 💪"))
            }
        }

        scm {
            connection.set("https://github.com/mooncloak/pagex.git")
            developerConnection.set("https://github.com/mooncloak/pagex.git")
            url.set("https://github.com/mooncloak/pagex")
        }
    }
}
