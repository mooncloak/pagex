//[pagex-core](../../../index.md)/[com.mooncloak.kodetools.pagex](../index.md)/[PageCollection](index.md)

# PageCollection

@[ExperimentalPaginationAPI](../-experimental-pagination-a-p-i/index.md)

@Serializable(with = [PageCollectionSerializer::class](../-page-collection-serializer/index.md))

interface [PageCollection](index.md)&lt;[Item](index.md)&gt; : [Page](../-page/index.md)&lt;[Item](index.md)&gt; 
...
| [pages](pages.md) | [common]<br>abstract val [pages](pages.md): [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)&lt;[ResolvedPage](../-resolved-page/index.md)&lt;[Item](index.md)&gt;&gt;<br>The [ResolvedPage](../-resolved-page/index.md)s in this [PageCollection](index.md). |
